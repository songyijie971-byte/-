...
def create_upload_analysis_service(deps) -> UploadAnalysisApplicationService:
    runtime = AnalysisRuntimeContext(
        ...
        allowed_image_extensions=deps["ALLOWED_IMAGE_EXTENSIONS"],
...
def build_analysis_services(deps):
    ...
    return {
        ...
        "allowed_image_file": service.allowed_image_file,
        ...
        "analyze_uploaded_image": service.analyze_uploaded_image,
